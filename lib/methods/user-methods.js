(function() {
  var Boom, Hoek, ObjectId, PageResult, UserMethods, bcrypt, errors, fnUnprocessableEntity, i18n, isObjectId, mongoose, mongooseRestHelper, passgen, _,
      ...
      return this.getByNameOrId(_tenantId, usernameOrId, (function(_this) {
        return function(err, item) {
          ...
          return item.save(function(err) {
            ...
            if (obj.password) {
              return _this.setPassword(_tenantId, usernameOrId, obj.password, {}, function(err, item2) {
                if (err) {
                  return cb(err);
                }
                return cb(null, item);
